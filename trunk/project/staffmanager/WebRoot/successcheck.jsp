...
<ul>
		 ...
		 <div id="leftcolumn">
			...
			<div id="leftnav">
                        ...
                        <div class="col">
	        <ul>		 
<img src="images/2.png" class="floatTL" alt="image" width="95" align="center"/>
		</ul>
              </div>
           </div>
		 ...
		 <div id="rightcolumn">
                ...
                <div id="boxes">
				 ...
				 <div>
				  <form action="departmentmanager.jsp">
				 <table width="541" height="206" border="1" align="center">
  ...
  <td>
   ...
   <s:iterator value="results" status="s">
			<tr>
				...
				<td><s:property value="results[#s.index].staff_number" /></td>
				<td><s:property value="results[#s.index].department_id" /></td>
				<td><s:property value="results[#s.index].role" /></td>
			</tr>
				</s:iterator>

  <input type="submit" name="Submit" value=" 完成&nbsp;&nbsp;" height="10" align="right"/>
</table>
