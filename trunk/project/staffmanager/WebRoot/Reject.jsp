...
<center>
 <!-- Begin Wrapper -->
   <div id="wrapper">
		 ...
		 <div id="leftcolumn">
			...
			<div id="leftnav">
                        ...
                        <div class="col">
	     <ul>
			<li><a href="checkflow.do?state=0" title="已审核">已审核</a></li>
			<li><a href="checkflow.do?state=1" title="未审核">未审核</a></li>   
			<li><a href="checkflow.do?state=2" title="驳回">驳回</a></li>
			<li><a href="dochart.do"  title="查看考核结果"  > 查看考核结果</a></li> 
		</ul>
  ...
  <tr>
    ...
    <th width="108" scope="col"><span class="STYLE1">已驳回</span></th>
 ...
 <!--   
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div align="center">已驳回</div></td>
   
  </tr>
  -->

  <c:forEach items="${checkflowlist}" var="basicinfo">
  <tr>
    <th height="47" scope="row"><c:out value="${basicinfo.name}"/></th>
    <td><c:out value="${basicinfo.staffNumber}"/></td>
    <td><c:out value="${basicinfo.departmentinfo.departmentName}"/></td>
    <td><c:out value="${basicinfo.role}"/></td>
    <td><div align="center">已驳回</div></td>
		       ...
		       <div>
				  <a href="GeneralManager.jsp"><img src="images/button/04.gif" alt="image" class="floatTL"/></a>
