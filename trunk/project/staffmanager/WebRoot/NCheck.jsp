...
name=encodeURI(name);
name=encodeURI(name);
window.location="BeginCheck.do?commitname="+name;
}
</script>
</head>
   ...
   <div id="wrapper">
	...
	<ul>
		 ...
		 <div id="leftcolumn">
			...
			<li><a href="Gcheckflow.do?state=0" title="">已审核</a></li>
			 <li><a href="Gcheckflow.do?state=1" title="">未审核</a></li>
			 <li><a href="Gcheckflow.do?state=2" title="">驳回</a></li>  
		 ...
		 <div id="rightcolumn">
                ...
                <div id="boxes">
				 ...
				 <div>
				  ...
				  <table align="center" width="520" height="161" border="1">
      <tr>
...
<c:forEach items="${list}" var="b">
  <tr>
   ...
   <td><div align="center"><a href="javascript:aa('<c:out value="${b.name}"/>')">未考核</a></div></td>   
  </tr>
  </c:forEach>
</table>
