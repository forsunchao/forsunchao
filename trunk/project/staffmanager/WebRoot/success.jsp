					...
					<div class="col">
						<ul>
							...
							<form action="doquery.do" method="post">
								...
								<li>
									<a href="#" title="search1" onclick="doquerySubmit()">
							...
							<li>
								...
								<a href="#" title="search1" onclick="viewchartSubmit()"><font color=#F08080face="隶书"><s:property value="getText('chakan')"/></FONT></a>
...
<li>
  ...
  <a href="lang.do?request_locale=zh_CN">中文</a>
				...
				<div>
<table border="1" width="468" height="165">
	
	<tr>
	
				<td><font size="2" color=#ffccrr>名字</font>  </td>
				<td>学历    </td>
			 <td>部门    </td>
				<td>婚否     </td>
				<td>身份证   </td>
			 ...
			 <c:forEach items="${basicinfo}" var="basic" >
			   <tr> <td><c:out value="${basic.name}"/></td>
			
				<td><c:out value="${basic.education}" /></td>
			<td><c:out value="${basic.department}" /></td>
				<td><c:out value="${basic.ismarried}" /></td>
				<td><c:out value="${basic.personId}" /></td>
				<td><c:out value="${basic.password}" /></td>
				<td><c:out value="${basic.nation}"/></td>
			   <td><c:out value="${basic.birthday}"/></td> </tr>
			 </c:forEach>
		</table> 
