...
<ul>
		 ...
		 <div id="rightcolumn">
				...
				<table align="center" border="1" width="400">
				 <s:iterator value="steplist" status="s">
				 <tr>
				 <td>
				 姓名
				 </td>
				 ...
				 <tr>
				 <td>
				 <s:property value="steplist[#s.index].commiter"/>
				 </td>
				 <td>
				 <s:property value="steplist[#s.index].accepter"/>
				 </td>
				  <td>				 			 				 
				 <s:property value="steplist[#s.index].checkflowState"/>
				 </td>
				 <td>
				 <s:property value="%{dynamicNumber}"/>
				 </td>
				  <td>
				 <s:property value="steplist[#s.index].checkflowGrade"/>
				 </td>
				 </tr>
				 </s:iterator>
				 <tr>
