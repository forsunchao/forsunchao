...
<ul>
		...
		<img src="images/3.png" class="floatTL" alt="image" width="95"/>
		 ...
		 <div id="rightcolumn">
               ...
               <s:iterator value="checkResult" status="s">
               <tr>
               <td>
               <s:property value="checkResult[#s.index].commiter"/>
               </td>
               <td>
               <s:property value="checkResult[#s.index].dynamicNumber"/>
               </td>
               <td>
               <s:property value="checkResult[#s.index].checkflowGrade"/>
               </td>
               <td>
               <s:property value="checkResult[#s.index].rejectRemark"/>
               </td>
               </tr>
               </s:iterator>
               </table>
