 ...
 <img src="images/2.png" class="floatTL" alt="image" width="95" align="center"/>
		 ...
		 <div id="rightcolumn">
                ...
                <div id="boxes">
				 ...
				 <tr>
				<td align="center">
				<textarea rows="12" cols="55" type="text" readonly=true onclick="alert('只读，不可以修改')" ><jsp:include flush="true" page="1.txt"></jsp:include></textarea></td>
				</tr>
				<form action="kaohepaper.do" method="post">
				<tr>
				<td height="30"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
