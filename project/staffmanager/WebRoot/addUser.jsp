   ...
   <div id="wrapper">
		 ...
		 <div id="rightcolumn">
  		...
  		<table border="1">
  			<tr>
  				<td>身份证号：</td>
  				<td><input type="text" name="basicinfo.personId"></td>
  			</tr>
  			<tr>
  				<td>姓名：</td>
  				<td><input type="text" name="basicinfo.name"></td>
  			</tr>
  			<tr>
  				<td>英文名：</td>
  				<td><input type="text" name="basicinfo.enname"></td>
  			</tr>
  			<tr>
  				<td>Name ID：</td>
  				<td><input type="text" name="basicinfo.nameId"></td>
  			</tr>
  			<tr>
  				<td>密码：</td>
  				<td><input type="password" name="basicinfo.password"></td>
  			</tr>
  			<tr>
  				<td>生日：</td>
  				<td><input type="text" name="basicinfo.birthday"></td>
  			</tr>
  			<tr>
  				<td>籍贯：</td>
  				<td><input type="text" name="basicinfo.nation"></td>
  			</tr>
  			<tr>
  				<td>教育：</td>
  				<td>
  			...
  			<tr>
  				<td>性别：</td>
  				<td><input type="radio" checked="checked" name="basicinfo.sex" value="男">男&nbsp;<input type="radio" name="basicinfo.sex" value="女">女</td>
  			</tr>
  			<tr>
  				<td>婚否：</td>
