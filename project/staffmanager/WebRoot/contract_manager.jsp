...
<center>
   ...
   <div id="wrapper">
			...
			<li>
								...
								<form action="sms/contract/doquery.do" method="post">
									<p>
										...
										<label>
											<input type="text" name="conditionValue" value="日期格式YYYY-MM-DD">
										</label>
										<input type="submit" value="查询">
								</form>			
			<li><a href="contract_reportforms.jsp" title="delete">生成报表</a></li>    
		</ul>
              </div>
           </div>
		 ...
		 <div id="rightcolumn">
		   ...
		   <div><img src="images/B2.jpg" class="floatTL" alt="image" width="500"/></div> 
				  <div>
				  <a href="#"><img src="images/button/04.gif" alt="image" height="40" class="floatTL"/></a><a href="#"><img src="images/button/03.gif"  height="40" alt="image" class="floatTR"/></a></div> 
		 </div>
		 <!-- End Right Column -->
